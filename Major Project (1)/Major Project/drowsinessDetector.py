    ...
    for rect in rects:
        ...
        if ear < EYE_AR_THRESHOLD:
            ...
            if COUNTER >= EYE_AR_CONSEC_FRAMES:
                s.write(b'a')  # Sending 'a' to Arduino
                s.flush()
            ...
            s.write(b'b')  # Sending 'b' to Arduino
            s.flush()
        ...
        cv2.putText(frame, "Batch-10 Capstone Project", (350, 470), cv2.FONT_HERSHEY_COMPLEX, 0.6, (0, 0, 0), 1)
